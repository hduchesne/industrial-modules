CKEDITOR.editorConfig = function (config) {
    ...
    config.templates = 'industrial-templates,default';
    config.stylesSet = 'B4:'+((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/industrial-templates/javascript/ckeditor/stylesSet.js';
    config.contentsCss = [
        ((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/bootstrap4-core/css/bootstrap.min.css',
        ((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/industrial-templates/css/style.css'
        // ((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/industrial-templates/javascript/ckeditor/css/editor.css'
    ];
    config.templates_files = [
        ...
        ((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/industrial-templates/javascript/ckeditor/templates.js'
    ];
