...
<c:set var="caption" value="${currentNode.properties['temp4i:caption'].string}"/>

<c:url var="videoURL" value="${currentNode.properties['temp4i:videoURL'].string}"/>
<c:url var="imageURL" value="${currentNode.properties['temp4i:image'].node.url}"/>
