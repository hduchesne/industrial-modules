...
<c:set var="type" value="${currentNode.properties['temp4i:carouselType'].string}"/>
...
<c:if test="${jcr:isNodeType(currentNode, 'temp4imix:owlcarouselAdvancedSettings')}">
    <c:set var="options" value="${currentNode.properties['temp4i:options'].string}"/>
    <c:set var="class" value="${currentNode.properties['temp4i:class'].string}"/>
</c:if>
